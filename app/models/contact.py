...
class ContactForm(BaseModel):
    ...
    full_name: str = Field(..., description="Nombre completo", min_length=2, max_length=100)
    email: EmailStr = Field(..., description="Correo electrónico")
    phone: str = Field(..., description="Número de teléfono", min_length=10, max_length=20)
    message: str = Field(..., description="Contenido del mensaje", min_length=10, max_length=2000)
