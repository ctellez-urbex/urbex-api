...
class UserRegister(BaseModel):
    ...
    first_name: Optional[str] = Field(None, description="User's first name", max_length=50)
    last_name: Optional[str] = Field(None, description="User's last name", max_length=50)
