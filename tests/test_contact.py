...
class TestContactEndpoints:
    ...
    def test_submit_contact_form_email_failure(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_admin_email_not_configured(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_email_service_not_configured(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_invalid_data(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_name_too_short(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_message_too_short(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_phone_too_short(
        self, client: pytest.FixtureRequest
    ) -> None:
    ...
    def test_submit_contact_form_with_special_characters(
        self, client: pytest.FixtureRequest
    ) -> None:
